    ...
    it('test case for creating new event api', (done) => {
      ...
      chai.request(server)
        ...
        .end((err, res) => {
          ...
          expect(res.body.output.eventDate).to.be.eql(newEventData.eventDate);
          done(err);
        });
    });
    ...
    it('test case for updating event api', (done) => {
      ...
      chai.request(server)
        ...
        .end((err, res) => {
          ...
          expect(res.body.events.eventDate).to.be.eql(newData.eventDate);
          done(err);
        });
    });
    ...
    it('test case for deleting event api', (done) => {
      ...
      chai.request(server)
        ...
        .end((err, res) => {
          ...
          expect(res.body.deleteOutput.eventDate).to.be.eql(newData.eventDate);
          done(err);
        });
    });
  });
